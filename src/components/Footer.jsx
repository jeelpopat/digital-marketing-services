      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
        ...
        <div className="lg:col-span-5 flex flex-col space-y-6">
          ...
          <div className="flex items-center space-x-4 pt-4">
            <a href="https://www.facebook.com/login/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center text-black hover:text-[#3DE073] transition-colors">
            ...
            <a href="https://twitter.com/login" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center text-black hover:text-[#3DE073] transition-colors">
            ...
            <a href="https://www.linkedin.com/login" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center text-black hover:text-[#3DE073] transition-colors">
            ...
            <a href="https://www.instagram.com/accounts/login/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center text-black hover:text-[#3DE073] transition-colors">
        ...
        {/* 2. Navigation Section (UPDATED TO USE LINK) */}
        <div className="lg:col-span-2 lg:pl-4 flex flex-col space-y-6">
          ...
          <ul className="flex flex-col space-y-4 text-sm md:text-base">
            <li><Link to="/ourservice" className="text-gray-400 hover:text-black transition-colors">Service</Link></li>
            <li><Link to="/agency" className="text-gray-400 hover:text-black transition-colors">Agency</Link></li>
            <li><Link to="/casestudy" className="text-gray-400 hover:text-black transition-colors">Case Study</Link></li>
            <li><Link to="/resource" className="text-gray-400 hover:text-black transition-colors">Resource</Link></li>
            <li><Link to="/contact" className="text-gray-400 hover:text-black transition-colors">Contact</Link></li>
          </ul>
        </div>
        ...
        <div className="lg:col-span-2 flex flex-col space-y-6">
          ...
          <ul className="flex flex-col space-y-4 text-sm md:text-base">
            <li><Link to="/privacy-policy" className="text-gray-400 hover:text-black transition-colors">Privacy Policy</Link></li>
            <li><Link to="/copyright" className="text-gray-400 hover:text-black transition-colors">Copyright</Link></li>
          </ul>
        </div>
