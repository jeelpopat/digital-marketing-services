...
const WebsiteUIDesign = () => {
  return (
    <div className="min-h-screen bg-[#FDFDFD] flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-40 -left-40 w-96 h-96 bg-[#3DE073]/20 blur-[120px] rounded-full pointer-events-none z-0"></div>
        ...
        <div className="max-w-[1200px] mx-4 md:mx-12 lg:mx-30 space-y-16 md:space-y-24">
          ...
          <div className="flex flex-col lg:flex-row items-center mb-12 px-2 md:px-12 lg:px-16 gap-10 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left flex flex-col items-center lg:items-start">
              {/* Service Icon */}
              <div className="w-14 h-14 rounded-2xl bg-[#EBEFFA] text-[#2563EB] flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg md:text-xl font-normal text-[#3DE073] my-2">
                Research-Led Design That Drives Results
              </h3>
              <p className="text-gray-500 text-sm leading-relaxed font-medium max-w-xl">
                We create custom website designs, aligned with your brand identity, featuring user-centered layouts, responsive interfaces, and research-led UX including heatmaps, journey mapping, content strategy, and SEO optimization.
              </p>
            ...
            <div className="w-full lg:w-1/2">
              <div className="rounded-[2rem] overflow-hidden shadow-2xl border border-gray-100 transform hover:scale-[1.02] transition-transform duration-500">
                <img 
                  src={heroImage} 
                  alt="Website and UI/UX Design Process on Monitor" 
          ...
          <div className="space-y-10 mb-12" >
            <h2 className="text-3xl md:text-5xl font-normal text-black text-center">
              What's Included
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="bg-white border border-gray-100 rounded-xl px-4 py-4 flex items-center gap-4 shadow-lg hover:shadow-xl transition-shadow">
                  <div className="w-6 h-6 rounded-full bg-[#E2F5D6] text-[#3DE073] flex items-center justify-center shrink-0">
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={index} className="flex items-start gap-4">
                    <div className="w-7 h-7 rounded-md bg-[#3DE073] text-white flex items-center justify-center shrink-0 mt-0.5 shadow-sm">
                ...
                <ul className="space-y-5">
                  {[
                    ...
                    <li key={index} className={`flex items-center border-b border-gray-300 py-2 ${index === 0 ? 'border-t' : ''} gap-4`} >
                      ...
                      <span className="text-gray-700 font-semibold text-base">{deliverable}</span>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <div className="mx-0 md:mx-10 lg:mx-40 mb-16">
            <ServiceCTA 
              ...
              subtitle="Let's discuss your project and how our website & UI/UX design services can help you achieve your goals."
